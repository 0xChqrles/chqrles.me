---
title: "J’ai amélioré Cémantix avec une IA qui ne peut pas parler"
date: 2026-09-25
...
image: ./pigeon-knife.jpg
imageAlt: "Un pigeon s’envole d’une table de café avec un couteau dans le bec"
draft: true
---
...
Pourtant, l’article s’intitule **J’ai amélioré Cémantix avec une IA qui ne peut pas parler**. La théorie avait omis trois détails importants.
...
<Plane
  ...
  states={[
    ...
    },
    {
      label: 'centrés',
      points: [
        { id: 'h1', x: -0.07, y: 0.13 }, { id: 'h2', x: 0.18, y: -0.46 }, { id: 'h3', x: -0.31, y: 0.27 },
        { id: 'h4', x: 0.09, y: 0.07 }, { id: 'h5', x: 0.15, y: -0.3 }, { id: 'h6', x: -0.21, y: 0.32 },
        { id: 'h7', x: 0.07, y: 0.0 }, { id: 'h8', x: 0.24, y: -0.22 }, { id: 'h9', x: 0.0, y: 0.18 },
        { id: 'h10', x: -0.26, y: 0.19 }, { id: 'h11', x: -0.01, y: 0.2 }, { id: 'h12', x: 0.18, y: -0.36 },
      ],
    },
  ]}
/>
